    ...
    <div class="container">
      ...
      <div class="row justify-content-center btns">
        <div class="col-md-12 text-center">
          ...
          <button class="customNextBtn btn btn-primary m-1 " style="background-color: darkred;">Prev</button>
          <button class="customPreviousBtn btn btn-primary m-1 " style="background-color: darkred;">Next</button>
        </div>
      </div>
    </div> 
    <!-- <div class="container"> -->
